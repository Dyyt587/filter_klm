...
#define CREATE_MATRIX_ONSTACK_P(x,y,matrix,initval) \
...
typedef struct easyMatrix easyMatrix;

struct easyMatrix* setMatrix(DATA_TYPE* const a, struct easyMatrix* c); //初始化

struct easyMatrix* copyMatrix(struct easyMatrix* const a, struct easyMatrix* c); //copy

struct easyMatrix* transMatrix(struct easyMatrix* const a, struct easyMatrix* c); //转置

DATA_TYPE detMatrix(struct easyMatrix* const a); //删除

int invMatrix(struct easyMatrix* const a, struct easyMatrix* b);//
